...
snapshots["Search tests show project badge for external project results"] = 
`<div role="search">
  <div class="background">
  </div>
  <div class="content">
    ...
    <div class="results">
      <div class="hit">
        <div class="hit-block">
          <a
            class="hit-block-heading"
            href="http://localhost:8000/en/latest/index.html"
          >
            <i>
            </i>
            <div class="hit-block-heading-row">
          ...
          <a
            class="hit"
            href="http://localhost:8000/en/latest/index.html#test-section"
          >
            <div id="hit-test-section-0-0">
              <p class="hit subheading">
                Test Section
              </p>
              <p class="content hit">
...
`;
/* end snapshot Search tests show project badge for external project results */
